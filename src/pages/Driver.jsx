...
class Driver extends React.Component {
    ...
    componentDidMount() {
        fetch('http://localhost:8080/sundoadmin/driver.php/').then(response => {
    ...
    render() {
        ...
        if(customerFound) {
            return (
                <><><h1 className="Ctitle">Driver</h1></><><div id="msg"></div><button type="button" className="btn btn-danger" onClick={this.deleteEmployees}>Remove</button><Table className='CTable' striped bordered hover variant="dark">
                    <thead>
                        <tr>
