...
class Booking extends React.Component {
    ...
    render() {
        ...
        if(customerFound) {
            return (
                <><><h1 className="Ctitle">Bookings</h1></><><div id="msg"></div><button type="button" className="btn btn-danger" onClick={this.deleteEmployees}>Remove</button><Table className='CTable' striped bordered hover variant="dark">
                    <thead>
                        <tr>
