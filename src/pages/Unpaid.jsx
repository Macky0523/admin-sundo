...
class Unpaid extends React.Component {
    ...
    componentDidMount() {
        fetch('http://localhost:8080/sundoadmin/unpaid.php/').then(response => {
    ...
    render() {
        ...
        if(customerFound) {
            return (
                <><><h1 className="Ctitle">Unpaid Bookings</h1></><><div id="msg"></div><button type="button" className="btn btn-danger" onClick={this.deleteEmployees}>Remove</button><Table className='CTable' striped bordered hover variant="dark">
                    <thead>
                        <tr>
